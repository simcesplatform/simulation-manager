...
class TestEpochMessage(unittest.TestCase):
    ...
    def test_message_creation(self):
        ...
        message_full = tools.messages.EpochMessage.from_json(FULL_JSON)
    ...
    def test_message_json(self):
        ...
        message_full_json = tools.messages.EpochMessage.from_json(FULL_JSON).json()
    ...
    def test_message_bytes(self):
        ...
        message_full = tools.messages.EpochMessage.from_json(FULL_JSON)
        message_copy = tools.messages.EpochMessage.from_json(
